...
class Email extends CoreEmail
{
    ...
    protected function sendCustomerMail(Widerruf $oSubmission, array $aOrder)
    {
        ...
        $this->setBody($renderer->renderTemplate('@bmnnit_widerruf/widerruf_customer_html.html.twig', $this->getViewData()));
        $this->setAltBody($renderer->renderTemplate('@bmnnit_widerruf/widerruf_customer_plain.html.twig', $this->getViewData()));
    ...
    protected function sendAdminMail(Widerruf $oSubmission, array $aOrder)
    {
        ...
        $oMail->processViewArray();

        $renderer = $oMail->getRenderer();
        $oMail->setBody($renderer->renderTemplate('@bmnnit_widerruf/widerruf_admin_html.html.twig', $oMail->getViewData()));
        $oMail->setAltBody($renderer->renderTemplate('@bmnnit_widerruf/widerruf_admin_plain.html.twig', $oMail->getViewData()));
